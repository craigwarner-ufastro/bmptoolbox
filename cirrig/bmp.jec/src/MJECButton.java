...
public class MJECButton extends UFColorButton {
    ...
    public MJECButton(String name, String theTitle, String command, int COLOR_SCHEME, MjecFrame mjecFrame) {
	  ...
	  if (applyFirst) {
	    mjec.apply();
          ...
          if (doApply) {
            mjec.apply(MJECButton.this);
          }
        }
      });
      setToolTipText();
      mjec.registerButton(this);
    }

    public MJECButton(String name, String title, String command, int COLOR_SCHEME, MjecFrame mjecFrame, boolean showPopup) {
      this(name, title, command, COLOR_SCHEME, mjecFrame);
