...
public class MJECPlotPanel extends JPanel { 
    ...
    public MJECPlotPanel(MjecFrame mjecFrame, String[] recNames, String[] labels) {
	super();
	mjec = mjecFrame;
	recsToPlot = recNames;
	thePlot = new MJECPlot(mjec, recsToPlot); 
    ...
    public MJECPlotPanel(MjecFrame mjecFrame, String[] recNames) {
      this(mjecFrame, recNames, null);
    }
