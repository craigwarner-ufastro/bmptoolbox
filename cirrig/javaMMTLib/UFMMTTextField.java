...
public class UFMMTTextField extends JTextField implements UFMMTComponent, FocusListener, KeyListener, MouseListener {
    public static final String rcsID = "$Name:  $ $Id: UFMMTTextField.java,v 1.7 2014/10/28 21:11:31 warner Exp $";
    ...
    public UFMMTTextField(String name) {
      recName = name;
    ...
    public void addShadow(UFMMTComponent shadow) {
      if (shadow instanceof UFMMTTextField) {
	shadows.add(shadow);
      }
    }
	...
	UFMMTTextField shadow = (UFMMTTextField)shadows.get(j);
	shadow.clear();
