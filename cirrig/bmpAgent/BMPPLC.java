...
public class BMPPLC extends UFPLCifce implements Irrigator {
    ...
    protected int _pwrReg = 1104, _timerReg = 1105, _timerReg2=1106, _timerFlagReg=1107;
    protected int _yReg = 16706, _timerStatReg = 16961, _timerValReg = 0, _timerValReg2 = 1;
    protected String errMsg = "";

    private String _className = getClass().getName() + "> ";

    /** constructors */
    public BMPPLC( String host, int uid ) {
      _plcHost = host;
      _uid = uid;
    ...
    public synchronized boolean getPowerStatus() {
      ...
      if (bit == -1) System.out.println(_className+"::getPowerStatus> "+_plcHost+" ERROR reading register "+_yReg+" at "+ctime());
      _busy = false;
      if (bit == 2) return true;
      return false;
    }
    ...
    public static void main(String[] args) {
      BMPPLC plc = new BMPPLC("10.248.74.73", 1);
      plc.connect();
      System.out.println(plc.readRegister(16640));
      System.out.println(plc.readRegister(16704));
      plc.closeConnection();
    }
}
