...
//===========================================================================================
// Class WeewxClientThread extends UFMMTClientThread 

public class WeewxClientThread extends UFMMTClientThread { 

    protected String _className = getClass().getName();
    protected long _lastPing = -1;

    public WeewxClientThread( Socket clientSoc, int clientNumber, boolean sim) {
...
} //end of class WeewxClientThread
