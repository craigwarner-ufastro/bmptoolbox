...
public class MJECApplyButton extends UFColorButton {
    ...
    public MJECApplyButton(CjecFrame cjecFrame) {
      this(cjecFrame, "Apply", UFColorButton.COLOR_SCHEME_GREEN);
    }

    public MJECApplyButton(CjecFrame cjecFrame, String title, int COLOR_SCHEME) {
	...
	public void actionPerformed(ActionEvent ae) {
	  ...
	  if (doApply) {
	    cjec.apply(MJECApplyButton.this);
	    setEnabled(true);
	  }
	}
      });
