...
public class MJECPlotPanel extends JPanel { 
    ...
    public MJECPlotPanel(CjecFrame cjecFrame, String[] recNames, String[] labels) {
	super();
	cjec = cjecFrame;
	recsToPlot = recNames;
	thePlot = new MJECPlot(cjec, recsToPlot); 
    ...
    public MJECPlotPanel(CjecFrame cjecFrame, String[] recNames) {
      this(cjecFrame, recNames, null);
    }
