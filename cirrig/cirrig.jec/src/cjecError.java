...
/**
 * Title:        cjecError.java
 * Version:      (see rcsID)
 * Copyright:    Copyright (c) 2010
 * Author:       Craig Warner
 * Company:      University of Florida
 * Description:  Cjec Error frame
 */
 ...
 */
public class cjecError {
  public static final String rcsID = "$Name:  $ $Id: cjecError.java,v 1.1 2010/06/25 18:39:41 warner Exp $";
...
//-------------------------------------------------------------------------------
  ...
  private static void errorMsgFrameInit() {
    try {
      errorMsgFrame = new JFrame("cjecError Window");
      ...
      System.out.println("cjecError.errorMsgFrameInit> " + e.toString());
    }
...
//-------------------------------------------------------------------------------
  ...
  static Context getContext (int level) {
    ...
    try {
      ...
      System.out.println("Error reading printStackTrace output in cjecError");
    }
