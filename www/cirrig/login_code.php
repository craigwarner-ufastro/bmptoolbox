...
<?php
   ...
   if (isset($_POST['isSubmitted'])) {
      ...
      $sql = "select * from users where username='" . $user . "' and password='" . $passwd . "' and cirrig=1";
...
<br>
CIRRIG is for commercial use.  Please contact Tom Yeager (352-273-4574; yeagert@ufl.edu) or Jeff Million (352-538-1775; jmillion@ufl.edu) to see if CIRRIG will work for your nursery.
<br>
<br>
If you have obtained a registration password, <a href="register/register.php">click here to register</a>.
<br>
<br>
