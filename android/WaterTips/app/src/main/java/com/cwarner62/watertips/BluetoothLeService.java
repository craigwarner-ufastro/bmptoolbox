...
public class BluetoothLeService extends Service {
    private final static String TAG = com.cwarner62.watertips.BluetoothLeService.class.getSimpleName();
...
//        }
    ...
    public class LocalBinder extends Binder {
        com.cwarner62.watertips.BluetoothLeService getService() {
            return com.cwarner62.watertips.BluetoothLeService.this;
        }
    }
    ...
    public boolean initialize() {
        ...
        System.out.println("BluetoothLeService initialize2 "+mBluetoothManager);
